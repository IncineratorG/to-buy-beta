package com.tobuybeta.modules.app_widget.widget.widget_intents.types;

public class WidgetIntentTypes {
    public static final String ON_TITLE_PRESS = "ON_TITLE_PRESS";
