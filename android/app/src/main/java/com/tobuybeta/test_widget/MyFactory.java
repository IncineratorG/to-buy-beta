...
public class MyFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        String itemStatus = model.list().status(position);
        ...
        } else if (currentListType.equalsIgnoreCase(GeneralizedList.ALL_SHOPPING_LISTS)) {
            listItemPressIntent = WidgetIntents.onShoppingListItemPressFillInIntent(widgetID, itemId);
            rView.setOnClickFillInIntent(R.id.tvItemText, listItemPressIntent);
        }
        // =======
