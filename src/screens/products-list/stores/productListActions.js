...
export const pla_setSelectedCategoryIdForCategoriesList = ({id}) => {
  return {
    type: SET_SELECTED_CATEGORY_ID_FOR_CATEGORIES_LIST,
    payload: {id},
  };
};

export const pla_setSelectedCategoryIdForProductsList = ({id}) => {
  return {
    type: SET_SELECTED_CATEGORY_ID_FOR_PRODUCTS_LIST,
    payload: {id},
  };
};
...
export const pla_setProductsListCategoryUpdatingComplete = () => {
  return {
    type: SET_PRODUCTS_LIST_CATEGORY_UPDATING_COMPLETE,
    payload: {undefined},
  };
};
